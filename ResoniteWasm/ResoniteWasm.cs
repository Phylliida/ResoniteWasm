...
namespace WasiMinimalPolyfill2
{
    public class WasiFileSystem
    {
        ...
        public event WasmPolyfill.MemoryGrowthEvent OnMemoryGrowth;
        ...
        public WasiFileSystem(Wasmtime.Engine engine, Wasmtime.Linker linker, Wasmtime.Store store, string fileSystemWasmPath)
        {
            ...
            WasmPolyfill.AttachClockTimeExport(linker, store, () => memory, packageName: "wasi_snapshot_preview1");
...
namespace ResoniteEasyFunctionWrapperExampleMod
{
    ...
    public class ExportedWasmFunctions
    {
        ...
        public static WasiMinimalPolyfill2.WasiFileSystem CreateFileSystem(Wasmtime.Linker linker, Wasmtime.Store store)
        {
            return new WasiMinimalPolyfill2.WasiFileSystem(engine, linker, store, "C:/Users/yams/Desktop/prog/ResoniteWasm/memfs.wasm");
        }

        public static Wasmtime.Instance GetFileSystemInstance(WasiMinimalPolyfill2.WasiFileSystem fileSystem)
        {
